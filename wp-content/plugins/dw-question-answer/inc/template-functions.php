...
function dwqa_require_field_submit_question(){
	...
	<div class="user-email">
		...
		<span style="display: none"><?php printf( __( 'or <strong><a href="%s">login</a></strong> to submit question', 'dwqa' ), wp_login_url( apply_filters( 'the_permalink', get_permalink( get_the_ID() ) ) ) ) ?></span>
	</div>
	<?php  }
}
