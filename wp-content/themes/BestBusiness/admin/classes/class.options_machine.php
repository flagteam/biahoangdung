...
class Options_Machine {
	...
	public static function optionsframework_media_uploader_function($id,$std,$mod){
		...
		//Upload controls DIV
		//$uploader .= '<div class="upload_button_div"><img  src="'.get_bloginfo('template_directory').'/images/logo.png"/></div>';
		...
		//$uploader .= '<img  src="'.get_bloginfo('template_directory').'/images/logo.png"/>';
		...
		//  else{
		//	$uploader .= '<a class="of-uploaded-image" href="'. $upload . '">';
	    //	$uploader .= '<img class="of-option-image" id="image_'.$id.'" src="'.get_bloginfo('template_directory').'/images/logo.png' .'" alt="" />';
	    //	$uploader .= '</a>';
		//	}
