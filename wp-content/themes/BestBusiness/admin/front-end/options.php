	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div class="logo">
				...
				<span><?php echo ('v'. THEMEVERSION); ?></span><span class="themepix"> by <a href="http://themepix.com" target="_blank">ThemePix.com</a></span>
			</div>
		
			<div id="js-warning">Warning- This options panel will not work properly without javascript!</div>
				<div class="sponsored">Free Version</div>
			<div class="clear"></div>
