...
class VideoSidebarWidget extends WP_Widget {
		...
		function VideoSidebarWidget() {
				...
				$control_ops = array( 'width' => '100%', 'height' => 350, 'id_base' => 'videosidebar' );
				$this->WP_Widget( 'videosidebar', __('ThemePix Video Sidebar Widget', 'videosidebar'), $widget_ops, $control_ops );
